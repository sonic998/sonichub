...
local SonicDoorSide1 = Instance.new("Part")
SonicDoorSide1.Name = "SonicDoorSide1"
SonicDoorSide1.Anchored = true
SonicDoorSide1.BottomSurface = Enum.SurfaceType.Smooth
SonicDoorSide1.Transparency = 1
SonicDoorSide1.TopSurface = Enum.SurfaceType.Smooth
SonicDoorSide1.Color = Color3.fromRGB(33, 84, 185)
SonicDoorSide1.Material = Enum.Material.WoodPlanks
SonicDoorSide1.Size = Vector3.new(622, 598, 197)
SonicDoorSide1.CFrame = CFrame.new(247, 344.6780090332031, -358.60009765625)
SonicDoorSide1.Parent = HackerMansion
...
Texture.Parent = SonicDoorSide1

local SonicDoorSide2 = Instance.new("Part")
SonicDoorSide2.Name = "SonicDoorSide2"
SonicDoorSide2.Anchored = true
SonicDoorSide2.BottomSurface = Enum.SurfaceType.Smooth
SonicDoorSide2.Transparency = 1
SonicDoorSide2.TopSurface = Enum.SurfaceType.Smooth
SonicDoorSide2.Color = Color3.fromRGB(33, 84, 185)
SonicDoorSide2.Material = Enum.Material.WoodPlanks
SonicDoorSide2.Size = Vector3.new(622, 598, 197)
SonicDoorSide2.CFrame = CFrame.new(247, 344.6780090332031, -349.6000671386719, -1, 0, 0, 0, 1, 0, 0, 0, -1)
SonicDoorSide2.Parent = HackerMansion
...
Texture1.Parent = SonicDoorSide2

local SonicDoorSide11 = Instance.new("Part")
SonicDoorSide11.Name = "SonicDoorSide1"
SonicDoorSide11.Anchored = true
SonicDoorSide11.BottomSurface = Enum.SurfaceType.Smooth
SonicDoorSide11.Transparency = 1
SonicDoorSide11.TopSurface = Enum.SurfaceType.Smooth
SonicDoorSide11.Color = Color3.fromRGB(33, 84, 185)
SonicDoorSide11.Material = Enum.Material.WoodPlanks
SonicDoorSide11.Size = Vector3.new(622, 598, 197)
SonicDoorSide11.CFrame = CFrame.new(247, 344.6780090332031, -4227.60009765625)
SonicDoorSide11.Parent = HackerMansion
...
Texture2.Parent = SonicDoorSide11

local SonicDoorSide21 = Instance.new("Part")
SonicDoorSide21.Name = "SonicDoorSide2"
SonicDoorSide21.Anchored = true
SonicDoorSide21.BottomSurface = Enum.SurfaceType.Smooth
SonicDoorSide21.Transparency = 1
SonicDoorSide21.TopSurface = Enum.SurfaceType.Smooth
SonicDoorSide21.Color = Color3.fromRGB(33, 84, 185)
SonicDoorSide21.Material = Enum.Material.WoodPlanks
SonicDoorSide21.Size = Vector3.new(622, 598, 197)
SonicDoorSide21.CFrame = CFrame.new(247, 344.6780090332031, -4227.60009765625, -1, 0, 0, 0, 1, 0, 0, 0, -1)
SonicDoorSide21.Parent = HackerMansion
...
Texture3.Parent = SonicDoorSide21
